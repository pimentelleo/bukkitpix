package io.github.pimentelleo.bukkitpix.qrcode;
...
public class ImageCreator {
	...
	public static void generateMap(final BufferedImage image, Player p, OrderProduct op) {	
    	float version = BukkitPix.getRunningVersion();
        ...
        InventoryManager.updateMapMeta(BukkitPix.getInstance(), mapMeta, p, op);
